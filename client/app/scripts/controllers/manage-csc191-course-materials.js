...
/**
 * @ngdoc function
 * @name clientApp.controller:ManageCsc191CourseMaterialsCtrl
 * @description
 * # ManageCsc191CourseMaterialsCtrl
 * Controller of the clientApp
 */
 angular.module('clientApp')
   .controller('ManageCsc191CourseMaterialsCtrl', ['$scope', '$http', '$mdDialog',
     function($scope, $http, $mdDialog) {

       $scope.initFirst = function() {

         $scope.currentNavItem = 'csc191CM'
